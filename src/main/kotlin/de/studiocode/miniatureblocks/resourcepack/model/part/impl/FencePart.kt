...
import de.studiocode.miniatureblocks.build.concurrent.FenceBlockData
...
const val HALF_FENCE_POST_WIDTH = 4.0 / 16.0 / 2
const val HALF_FENCE_BEAM_WIDTH = 2.0 / 16.0 / 2

class FencePart(data: FenceBlockData) : Part() {
